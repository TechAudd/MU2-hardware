...
import sys
import os
sys.path.insert(0, '/home/visveshnaraharisetty/Desktop/utils/py532lib')


OUTPUT_PATH = Path(__file__).parent
ASSETS_PATH = OUTPUT_PATH / \
    Path(r"/home/visveshnaraharisetty/Desktop/build/assets/frame0/")
...
def read_rfid():
    ...
    res = card_data.hex().upper()
    print("Card dta", card_data.hex().upper())
    return res

# Function to handle RFID reader output and trigger API call


image_path = "/home/visveshnaraharisetty/Desktop/build/assets/frame0/"
...
def show_second_window(data):
   ...
   # Create the second window
    ...
    photo = get_image_from_url(
        "https://musecportal.s3.ap-south-1.amazonaws.com/2023/" + data["HTNO"] + ".jpg", 200, 257)
    print(photo)
    current_image = photo
    ...
    def close_second_window():
        window.destroy()
        first_window.after(5000, handle_rfid_output)
...
first_window.after(2000, handle_rfid_output)
